...
namespace ICIMS.Migrations
{
    ...
    [Migration("20181213022012_addauditstatustable")]
    partial class addauditstatustable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ICIMS.BusinessManages.BusinessAuditStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ICIMS.BusinessManages.PayAudit", b =>
                {
                    ...
                    b.Property<decimal?>("InitPayAmount")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ICIMS.BusinessManages.PayAuditDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("PayAuditId");

                    b.ToTable("PayAuditDetail");
                });
            ...
            modelBuilder.Entity("ICIMS.BusinessManages.UserManageUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ICIMS.BusinessManages.AuditMapping", b =>
                {
                    ...
                    b.HasOne("ICIMS.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");
                });
            ...
            modelBuilder.Entity("ICIMS.BusinessManages.PayAuditDetail", b =>
                {
                    b.HasOne("ICIMS.BusinessManages.PayAudit", "PayAudit")
                        .WithMany()
                        .HasForeignKey("PayAuditId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
